function [MOVINGREG] = registerImagesAffine(MOVING,FIXED)
...
% Auto-generated by registrationEstimator app on 15-Feb-2024
%-----------------------------------------------------------
...
fixedPoints = detectSURFFeatures(FIXED,'MetricThreshold',576.000000,'NumOctaves',4,'NumScaleLevels',6);
movingPoints = detectSURFFeatures(MOVING,'MetricThreshold',576.000000,'NumOctaves',4,'NumScaleLevels',6);
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',43.759985,'MaxRatio',0.437500);
